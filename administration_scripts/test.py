...
class MockResponse:
    ...
    @staticmethod
    def json():
        file_name = "./administration_scripts/predictions.json" # Full path needed by github actions
...
class TestPerformanceEvaluator:
    ...
    ground_truth_file_name = "./administration_scripts/ground_truth.json" # Full path needed by github actions
    ...
    def test_get_prediction(self, mock_response):
        ...
        prediction_file_name = "./administration_scripts/prediction.json" # Full path needed by github actions
